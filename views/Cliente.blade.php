...
<nav class="navbar navbar-expand-lg" id="navbar">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      <div class="nombre" onclick="mostrarSideBar({{session('idCliente') }})"><i id="user" class="fa-solid fa-circle-user fa-xl" ></i>{{ session('nombre_completo') }}</div>
      @endif
      </form>
    </div>
  </div>
...
<div id="sidebar">
  <div id="sidebarNombre" onclick="mostrarSideBar({{session('idCliente') }})">
    <h2 style="color:white; margin-left:10px" id="nombreTituloBoleto">{{ session('nombre_completo') }}</h2>
    <i id="user" style="font-size: 215%;margin-right: 2%;" class="fa-solid fa-circle-user fa-xl" ></i>
  </div>
  <div id="sidebarBoletos">
    <div class="boletodiv" id="renderizadoBoletos">
      <div id="boletoIdVuelo">AA2B</div>
      <div id="boletoIdDestino">Destino</div>
      <div id="boletoIdAsiento">A22</div>
    </div>
  </div>
</div>
